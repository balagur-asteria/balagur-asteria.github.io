...
const timeToStart = 'Sat May 28 2022 10:00:00 GMT+0300';
...
const startGame = userName=>{
    ...
    frame.src = 'https://www.jigsawplanet.com/?rc=play&pid=24872f9dd34c&view=iframe&bgcolor=0x808080&rotation=1&savegame=1';
...
const showButtonStart = ()=>{
    document.querySelector('#nik .title').classList.remove('hidden');
...
const showTimer = ()=>{
    document.querySelector('#nik .title').classList.add('hidden');
